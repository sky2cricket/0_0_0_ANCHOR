...
print "var adb_project_name  = 'Training'; \n";
...
<!---------------------------->
<frameset cols="90,*"  border="01">
	<frame name="T" src="volvoices/vv/page_links_training2.htm" >
	<frameset rows="150,*" >

		<frame name="U" src="volvoices/vv/page_upper.htm"  >
		<frame name="D" src="volvoices/vv/page_welcome_training2.htm" scrolling="yes">
	</frameset>
</frameset>
<!--------------------------->
