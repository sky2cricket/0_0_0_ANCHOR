...
if ( document.forms[0].creator_radio_01[0].checked ==true) {//personal
        ...
        if (document.forms[0].creator_complexname_01.value != "" ) {
                //OLD WAY ps[ps.length]=new String(obrak+'mods:namePart type="family">'
                ps[ps.length]=new String(obrak+'mods:namePart>'
                        + bfont + replace_apos(document.forms[0].creator_complexname_01.value) + efont
                        + obrak +'/mods:namePart>\r\n'
                        );
        }else{//do traditional family-first-middle name
...
if ( document.forms[0].creator_radio_02[1].checked == true ) {//personal
        ...
        //check for complex-personal-name first
        if (document.forms[0].creator_complexname_02.value != "" ) {
                ps[ps.length]=new String(obrak+'mods:namePart>'
...
if ( document.forms[0].creator_radio_03[1].checked == true ) {//personal
        ...
        //check for complex-personal-name first
        if (document.forms[0].creator_complexname_03.value != "" ) {
                ps[ps.length]=new String(obrak+'mods:namePart>' 
...
var  strExtentAll =  new String("");
var  strExtentPages =  new String("");
var  strExtentObjects = new String("");
var  strExtentDimensions = new String("");

//do not make empty tags for extent
if (   ( document.forms[0].extent_pages.value.length > 0 )
    || ( document.forms[0].extent_number_of_objects.value.length > 0 ) 
    || ( document.forms[0].extent_dimensions.value.length > 0 )
) {//make the tag

if ( document.forms[0].extent_pages.value.length > 0 ) {
	var NstrExtent = new Number(document.forms[0].extent_pages.value);
	strExtentPages = new String(document.forms[0].extent_pages.value);
	if ( NstrExtent == 1)  {
		strExtentPages = strExtentPages + " digital image";
	}else{
		strExtentPages = strExtentPages + " digital images";
	}
}

if ( document.forms[0].extent_number_of_objects.value.length > 0 ) {
	strExtentObjects = "; "+document.forms[0].extent_number_of_objects.value ;
}


if ( document.forms[0].extent_dimensions.value.length > 0 ) {
	strExtentDimensions =   "; " + document.forms[0].extent_dimensions.value;
}

strExtentAll = strExtentPages+strExtentObjects+strExtentDimensions;

ps[ps.length]= new String(obrak+'mods:extent>'
	+ bfont + replace_apos(strExtentAll) + efont 
	+ obrak+'/mods:extent>\r\n'
	);
...
//document.forms[0].subject_topic_lcsh_01.value = document.forms[0].subject_topic_lcsh_01.value.replace(/ - /gi," -- ");
//parent.U.document.UF.subject_topic_lcsh_01.value = document.DF.subject_topic_lcsh_01.value
...
///////////////////////////////////////////////////////////// <mods:physicalLocation type="manuscriptNumber" 
