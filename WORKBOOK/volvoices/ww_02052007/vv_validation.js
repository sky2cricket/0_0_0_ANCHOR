...
var FORM_VAR_CHECK = new String();
    FORM_VAR_CHECK ="document.forms[0]."+FORM_VAR+"[0].selected ";

//	if ( eval(FORM_VAR_CHECK) == true) {return true;}


if ( document.forms[0].collection_id_num_type[0].selected == true) {return true;}
...
if (FORM_VAR2_VALUE =="" ) {
	alert("You have selected a value for : \n\n"+alert_name+"\n\nYou must also enter a value for " +alert_name2+ "."
	+"\n\nIf you have no value for "+alert_name2+", enter 'unknown' .");
	eval(this_focus);
	return false;
	}else {
	return true;
...
if  (!checkOneDependsOnTwo2("collection_id_num_type","Collection ID Number Type","collection_id_number","Collection ID Number")  )    return false;
