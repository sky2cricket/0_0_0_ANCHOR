...
if ( B.indexOf('<mods:subject authority="vv">') > -1 ) {
	...
	parent.U.document.UF.subject_topic_vv_01.value = getEntityData('<mods:topic>',strVV);
	var fixTopic_01 = new String(parent.U.document.UF.subject_topic_vv_01.value);
	...
	parent.U.document.UF.subject_topic_vv_02.value = getEntityData('<mods:topic>',strVV);
	var fixTopic_02 = new String(parent.U.document.UF.subject_topic_vv_02.value);
	...
	parent.U.document.UF.subject_topic_vv_03.value = getEntityData('<mods:topic>',strVV);
	...
	parent.U.document.UF.subject_topic_vv_04.value = getEntityData('<mods:topic>',strVV);
	...
	parent.U.document.UF.subject_topic_vv_05.value = getEntityData('<mods:topic>',strVV);
...
if ( B.indexOf("<mods:location") > -1) {
	...
	parent.U.document.UF.collection_id_number.value = getEntityData('<mods:physicalLocation ', B1a);
}
