...
if (FORM_VAR2_VALUE =="" ) {
	document.forms[0].collection_id_num_type[0].selected = true;
...
if (   (document.forms[0].subject_topic_lcsh_01.value == "" )
    && (document.forms[0].subject_topic_tgm_01.value  == "" )
    && (document.forms[0].subject_topic_none_01_desc.value  == "" )
   ) {
