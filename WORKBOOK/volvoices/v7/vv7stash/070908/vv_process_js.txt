...
//The main purpose of this function is to break the xml input file
//into small enough pieces for me to understand.
...
//I am storing these in the upper frames to make debug easier.
...
//mods_header
parent.U.document.U2.mods_header.value = chompStr.substring(0,chompStr.indexOf("<mods:titleInfo>"));
chompStr = chompStr.substring(chompStr.indexOf("<mods:titleInfo>"));

//mods_titleInfo <mods:titleInfo>...</mods:titleInfo>
index = chompStr.indexOf("</mods:title>") +13;
parent.U.document.U2.mods_titleInfo.value = chompStr.substring(chompStr.indexOf("<mods:title"),index);

//mods_name_group -- all name blocks together <mods:name>...</mods:name><mods:name>...repeats...</mods:name>
index = chompStr.indexOf("<mods:name");//start nameInfo 
index2 = chompStr.indexOf("<mods:originInfo");//this works because mods:originInfo is required
parent.U.document.U2.mods_name_group.value = chompStr.substring(index,index2);

//mods_originInfo <mods:originInfo>...</mods:originInfo>
index = index2;
index2 = chompStr.indexOf("<mods:language");//mods:language is required
...
if (index_ri>-1) {
	index2 = -1;
	index2 = chompStr.indexOf("<mods:identifier ");
	if (index2 == -1 ) {
		index2 = chompStr.indexOf("<mods:location>");
		}
