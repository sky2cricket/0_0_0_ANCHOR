...
if ( !document.forms[0].place_of_origin_authority[0].selected ) {
	if (document.forms[0].place_of_origin_authority[1].selected ) {
		origin_authority=" type=\"text\" authority=\"marccountry\" ";
	}else if (document.forms[0].place_of_origin_authority[2].selected ) {
		origin_authority=" type=\"code\" authority=\"marccountry\" ";
	}else if (document.forms[0].place_of_origin_authority[3].selected ) {
		origin_authority=" type=\"text\" authority=\"iso1366\" ";
	}else if (document.forms[0].place_of_origin_authority[4].selected ) {
