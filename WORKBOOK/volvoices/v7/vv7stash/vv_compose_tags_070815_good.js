...
function buildTagsArray_page_04_single(N){
...
for (k=0;k<numSB;k++) {
str_a="a=document.DF.subject_0"+k+".value";
str_b="b=document.DF.subject_0"+k+"_auth.value";
str_c="c=document.DF.subject_0"+k+"_auth_close.value";
