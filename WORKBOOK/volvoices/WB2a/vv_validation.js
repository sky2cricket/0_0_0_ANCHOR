...
//The authority is automatically entered except for Genre OTHER, so validate here.

if (thisDocument.forms[0].mods_genre_other.value != "") {
//function checkRequired_for_two_of_two(form_var,alert_name,form_var2, alert_name2) {
	if (!checkRequired_for_two_of_two("mods_genre_other_auth","Genre Authority OTHER","mods_genre_other", "Genre OTHER")) return false;
	}
