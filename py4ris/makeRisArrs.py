...
#see note below:
#DO NOT ATTEMPT TO PARSE DATE FIELD-TOXIC DATA


#command line:
#python makeRisArrs.py source_dir  target_dir >> redirectText
#python makeRisArrs.py arrsIN      arrsOUT    >> optionalLog.txt

#use a log file instead of print to screen.

#commonalities for arrs files
...
# N2  - (Description): Date of Document Creation: 1886-08-10; &nbsp;&nbsp;&nbsp; Date of Digital Publication: 2009
...
testTitlePost = " - 130806 docBlock6 ARRS "
...
for item in Flist:
	...
	for item in Flines:
		...
		if s0.find("<dc:date>")>-1:
			...
			s3 = s2.lstrip(" ")
			s4 = s3 #+testTitlePost #tag at end for testing
			myTitle = '\nTI  - '+s4+' '
