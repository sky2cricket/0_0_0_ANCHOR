...
alert("Sorry.  \n\n WRONG BUTTON!\n\n YOU SHOULD HAVE USED THE\n\nGO TO DC WORKBOOK BUTTON.");
 alert("Welcome to the DC WORKBOOK!");
        document.title="DC WORKBOOK";
        var scroll = new String();
            scroll = "no";//no for public, yes for test
                          //hard coded scrolling values do not change
        //'<frameset border="0" rows="1,1,100,54,*" scrolling="yes" >'//public
        //'<frameset border="10" rows="100,100,100,54,*" scrolling="yes" >'//test
        document.write(
        '<frameset border="0" rows="1,1,100,54,*" scrolling="yes" >'//public
        +'<frame name="P" src="../DCWORKBOOK/PILOT4/frameP/chd_page_init.htm" scrolling="'
        + scroll+'">'
        +'<frame name="U" src="../DCWORKBOOK/PILOT4/frameU/chd_page_upper.htm" scrolling="'
        + scroll+'">'
        +'<frameset border="0" cols="340,*" scrolling="no" >'
        +'  <frame name="H" src="../DCWORKBOOK/PILOT4/frameH/hdr.htm" scrolling="'
        +' scroll+">'
        +'  <frame name="I" src="../DCWORKBOOK/PILOT4/frameI/DCW.htm" scrolling="yes">'
        +'</frameset>'
        +'<frame name="B" src="../DCWORKBOOK/PILOT4/frameB/page_one_buttons.htm">'
        +'<frame name="D" src="../DCWORKBOOK/PILOT4/frameD/pilot_page_one.htm" scrolling="yes">'
        +'</frameset>'
        );
}
</script>
