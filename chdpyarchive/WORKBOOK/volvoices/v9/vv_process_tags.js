...
parent.U.document.UF.VVcomment_04.value   = B[15];//PAGE VALIDATION
...
parent.U.document.UF.validate_page_header.value   	= A[33];
parent.U.document.UF.validate_page_titleInfo.value   	= A[34];
parent.U.document.UF.validate_page_name.value   	= A[35];
parent.U.document.UF.validate_page_typeOfResource.value = A[36];
parent.U.document.UF.validate_page_genre.value   	= A[37];
parent.U.document.UF.validate_page_originInfo.value   	= A[38];
parent.U.document.UF.validate_page_language.value   	= A[39];
parent.U.document.UF.validate_page_physicalDescription.value = A[40];
parent.U.document.UF.validate_page_abstract.value   	= A[41];
parent.U.document.UF.validate_page_subject.value   	= A[42];
parent.U.document.UF.validate_page_relatedItem.value   	= A[43];
parent.U.document.UF.validate_page_identifier.value   	= A[44];
parent.U.document.UF.validate_page_location.value   	= A[45];
parent.U.document.UF.validate_page_accessCondition.value= A[46];
parent.U.document.UF.validate_page_recordInfo.value   	= A[47];
return;
}
