...
set_output_option(N);
	...
	var commentNumLocationUrlBlocks    	= new String(parent.U.document.UF.VVcomment_02d.value);
	var commentNumAccessConditionBlocks    	= new String(parent.U.document.UF.VVcomment_02e.value);
	...
	if ( num >0 ) {
        	...
        	commentNumLocationUrlBlocks    	= commentNumLocationUrlBlocks.replace(/\</g,"&#060;");
        	commentNumAccessConditionBlocks = commentNumAccessConditionBlocks.replace(/\</g,"&#060;");
...
ps[ps.length] = new String(commentNumLocationUrlBlocks+" \r\n"); 
ps[ps.length] = new String(commentNumAccessConditionBlocks+" \r\n"); 
...
if (parent.U.document.UF.validate_page_location.value == "n") {
        return;
        }
...
//////this is hard coded on input form and not like the dyn_location form vars
...
if (i==0) {
	attr_usage = ' usage="primary display" ';
}else{
	attr_usage = '';
}
...
//do not build empty tags for accessCondition
if (parent.U.document.UF.validate_page_accessCondition.value == "n") {
        return;
        }
