...
var b9  = new String('');//NUMBER_OF_RELATED_ITEMS:
...
if (a[i].indexOf('Institution')> -1 )        	b7  = a[i];//calculate admin db institution
if (a[i].indexOf('Date:') > -1 
|| a[i].indexOf('Timestamp:')>-1 )         	b8  = a[i];
//if(a[i].indexOf('NUMBER_OF_RELATED_ITEMS')>-1)  b9  = a[i]; always calculate
...
//////////ALERT - NEED NEW CODE FOR RELATED ITEMS////////////////////////////
...
b9 = "<!-- NUMBER_OF_RELATED_ITEMS: "+numConstituents+": -->";
parent.U.document.UF.VVcomment_02.value = b9;
parent.U.document.UF.numRelatedItems.value=numConstituents;
...
//Institution - harvest from  b7 comment
var g = new String(b7);
    g = g.substring(g.indexOf("Institution:"));
    g = g.substring(13, g.indexOf("-->"));
var InstName = new String(g);
parent.U.document.UF.VVcomment_03p.value = b7;
parent.U.document.UF.institutionName.value=InstName;

// contributorName - harvest from b6 comment
var g = new String(b6);
    g = g.substring(g.indexOf("Content Contributor:"));
    g = g.substring(21, g.indexOf("-->"));
var ContributorName = new String(g);
parent.U.document.UF.VVcomment_03c.value = b6;
parent.U.document.UF.contributorName.value=ContributorName;


////XMLBASE, XMLmaster_simple, XMLPATH_simple, XMLPATH, XMLPATHFULL
////harverst these from filename comment VVcomment_01, b5


var g = new String(b5);
    g = g.substring(g.indexOf("FILENAME:"));
    g = g.substring(10, g.indexOf("-->"));

var g2index = g.lastIndexOf("\\")+1;
var g2 = new String();
    g2 = g.substring(0,g2index);
var g3 = new String(g.substring(g2index));

var g4 = new String(g3);
    g4 = g4.replace(/0000.xml/gi,"");

//alert ("g="+g +"\ng2="+g2+"\ng3="+g3+"\ng4="+g4);

//parent.U.document.UF.XMLBASE.value = g4;
parent.U.document.UF.XMLmaster_simple.value = g3;
//parent.U.document.UF.XMLPATH_simple.value = g2;
//parent.U.document.UF.XMLPATH.value = g2;
//parent.U.document.UF.XMLPATHFULL.value = g2;
...
if (!isNaN(parent.U.document.UF.numRelatedItems.value ) ) {
    N = Number(parent.U.document.UF.numRelatedItems.value);
}else{
	parent.U.document.UF.numRelatedItems.value = "0";
	return("");
}
