...
//usage: onKeyPress="return parent.L.stopCutAndPaste(this,event);"
//usage: onKeyDown="return parent.L.stopCutAndPaste(this,event);"

function stopCutAndPaste(sbox,event) {
return;

if ( parent.adb_username == "tconner2" || parent.adb_username == "cricket.deane")return;
