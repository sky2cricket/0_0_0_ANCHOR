...
if (!parent.D.document.forms[0].creator_radio_02[0].checked ) {
        if (parent.D.document.forms[0].creator_lastname_02.value == "" && parent.D.document.forms[0].creator_complexname_02.value == "") {
...
if (!parent.D.document.forms[0].creator_radio_03[0].checked ) {
        if (parent.D.document.forms[0].creator_lastname_03.value == "" && parent.D.document.forms[0].creator_complexname_03.value == "") {
