...
var aNameRole   = new Array();
    ...
    for (j=0;j<numNB;j++){
        ...
        if (thisNameLast != "empty_string") {
                ...
                }else{//corp, conf, personal2-unparsed personal
...
//=================================================================
///returns the ps array
function xbuildTagsArray_tableOfContents(N){
//alert("buildTagsArray_tableOfContents");

set_output_option(N);

var ps=new Array();

//do not make empty <mods:tableOfContents>...</mods:tableOfContents> tags
var str = new String(parent.U.document.UF.toc_block_list.value);
...
var tempStr = new String(str);
	...
	//alert(" 3. tableOfContents  tempStr=\n"+tempStr+"\n tempStr.length="+tempStr.length);
...
}//end function buildTagsArray_tableOfContents()
...
//=================================================================
///returns the ps array
function buildTagsArray_tableOfContents(N){
//alert("buildTagsArray_tableOfContents");
...
//=================================================================
///returns the ps array
function buildTagsArray_targetAudience(N){
//alert("buildTagsArray_targetAudience");

set_output_option(N);

var ps=new Array();

//do not make empty <mods:targetAudience>...</mods:targetAudience> tags
var str = new String(parent.U.document.UF.taud_block_list.value);
...
if (tempStr.length == 0) return(ps);
alert("targetAudience: str="+str);


}//end function buildTagsArray_targetAudience()

//=================================================================
//=================================================================
///returns the ps array
function buildTagsArray_note(N){
//alert("buildTagsArray_note");

set_output_option(N);

var ps=new Array();

//do not make empty <mods:note>...</mods:note> tags
var str = new String(parent.U.document.UF.note_block_list.value);
...
}//end function buildTagsArray_note()
...
//=================================================================
///returns the ps array
function buildTagsArray_classification(N){
//alert("buildTagsArray_classification");
...
//do not make empty <mods:tableOfContents>...</mods:tableOfContents> tags
var str = new String(parent.U.document.UF.clas_block_list.value);
...
if (tempStr.length == 0) return(ps);
alert("classification str="+str);


}//end function buildTagsArray_classification()
...
//=================================================================
///returns the ps array
function buildTagsArray_part(N){
//alert("buildTagsArray_part");

set_output_option(N);

var ps=new Array();

//do not make empty <mods:part>...</mods:part> tags
var str = new String(parent.U.document.UF.part_block_list.value);
...
//=================================================================
///returns the ps array
function buildTagsArray_extension(N){
//alert("buildTagsArray_extension");

set_output_option(N);

var ps=new Array();

//do not make empty <mods:extension>...</mods:extension> tags
var str = new String(parent.U.document.UF.ext_block_list.value);
