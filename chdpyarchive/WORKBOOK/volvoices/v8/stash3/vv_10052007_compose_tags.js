...
if (thisDocument.forms[0].mods_genre_aat.value != "" ) {
genre_authority_tag_display = ' authority="'+bfont+thisDocument.forms[0].mods_genre_authority_aat.value +efont+'"';

var s = new String(thisDocument.forms[0].mods_genre_aat.value);
    s = s.replace(/; /g,";");
var a = s.split(";");
var e = new String();
...
/*
ps[ps.length]= new String(obrak+'mods:genre '+ genre_authority_tag_display + '>'
        + bfont + replace_apos(thisDocument.forms[0].mods_genre_aat.value) + efont
        + obrak +'/mods:genre>\r\n'
        );
*/
}//end if not empty
...
if (thisDocument.forms[0].mods_genre_chenhall.value != "" ) {
genre_authority_tag_display = ' authority="'+bfont+thisDocument.forms[0].mods_genre_authority_chenhall.value +efont+'"';

var s = new String(thisDocument.forms[0].mods_genre_chenhall.value);
    s = s.replace(/; /g,";");
var a = s.split(";");
var e = new String();
for (i=0;i<a.length;i++) {
...
/*
ps[ps.length]= new String(obrak+'mods:genre '+ genre_authority_tag_display + '>'
        + bfont + replace_apos(thisDocument.forms[0].mods_genre_chenhall.value) + efont
        + obrak +'/mods:genre>\r\n'
        );
*/
}//end if not empty
...
genre_authority_tag_display = ' authority="'+bfont+thisDocument.forms[0].mods_genre_authority.value +efont+'"';

var s = new String(thisDocument.forms[0].mods_genre.value);
    s = s.replace(/; /g,";");
var a = s.split(";");
var e = new String();
for (i=0;i<a.length;i++) {
...
///do not make empty tags for language
if (thisDocument.forms[0].language.value != ""){ 
