...
function buildTagsArray_header(N){
	...
	////alert("1. buildTagsArray_header: commentFilename=\n"+commentFilename);
	//alert("commentDate=\n"+commentDate);
	...
	////alert("2. buildTagsArray_header: commentFilename=\n"+commentFilename);
...
function buildTagsArray_closer(N){
	...
	//N=0 no red, use '<' in xml tag
	//N>0 insert red use '&#x003C; //prev '&#060;' (prev '&lt;') in xml tag to make html viewable
