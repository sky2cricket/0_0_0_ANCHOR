...
function buildTagsArray_header(N){
	...
	var commentDate     = new String(parent.U.document.UF.VVcomment_02.value);
...
ps[ps.length] = new String(obrak +'mods:mods xmlns:mods="http://www.loc.gov/mods/v3" \r\n' 
	+' xmlns:xlink="http://www.w3.org/1999/xlink" ID="MODS" version="3.2" \r\n'
...
if (!document.forms[0].name_authority_01_radio[0].checked) {
   name_authority_01_display = 'authority="'+document.forms[0].name_authority_01.value+ '" ';
}

if ( document.forms[0].creator_radio_01[0].checked == true ) {
	name_type_01_display = ' type="personal" ';
}else if ( document.forms[0].creator_radio_01[1].checked==true ) {
	name_type_01_display = ' type="corporate" ';
}else {
...
if (!document.forms[0].name_authority_02_radio[0].checked) {
   name_authority_02_display = 'authority="'+document.forms[0].name_authority_02.value+ '" ';
}

if ( document.forms[0].creator_radio_02[1].checked == true ) {
	name_type_02_display = ' type="personal" ';
}else if ( document.forms[0].creator_radio_02[2].checked==true ) {
	name_type_02_display = ' type="corporate" ';
}else {
...
if (!document.forms[0].name_authority_03_radio[0].checked) {
   name_authority_03_display = 'authority="'+document.forms[0].name_authority_03.value+ '" ';
}

if ( document.forms[0].creator_radio_03[1].checked == true ) {
	name_type_03_display = ' type="personal" ';
}else if ( document.forms[0].creator_radio_03[2].checked==true ) {
	name_type_03_display = ' type="corporate" ';
}else {
...
if (document.forms[0].mods_genre_radio[0].checked) {
   	genre_authority_tag_display = 'authority="aat" ';
}else if (document.forms[0].mods_genre_radio[1].checked) {
   	genre_authority_tag_display = 'authority="nmc" ';
}else if (document.forms[0].mods_genre_radio[2].checked) {
	genre_authority_tag_display = 'authority="marcgt" ';
}
...
ps[ps.length]= new String(obrak+'mods:subject authority="tgm"> \r\n');
...
////BEGIN VV AUTHORITY
ps[ps.length]= new String(obrak+'mods:subject authority="vv"> \r\n');
...
ps[ps.length]= new String(obrak+'mods:subject authority="spc"> \r\n');
...
ps[ps.length]= new String(obrak+'mods:physicalLocation type="'+colidn_type+'">'
