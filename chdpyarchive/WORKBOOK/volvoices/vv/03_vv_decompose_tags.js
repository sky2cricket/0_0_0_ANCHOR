...
var MEB_cursor=0;
    ...
    parent.mods_titleInfo=get_MODS_element_block2('<mods:titleInfo','</mods:titleInfo>','<mods:name',chompStr,MEB_cursor);
    MEB_cursor += parent.mods_titleInfo.length;
...
parent.mods_titleInfo = mods_titleInfo;
...
alert("parent.mods_title_info=\n"+parent.mods_title_info);
...
if ( B.indexOf("!-- Project:")> -1 ) {
	...
	var startProjectName = B.indexOf("<!--  Created by") +16;
