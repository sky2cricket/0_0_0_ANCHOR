...
alert( "You have entered directory name:\n\n"+document.DF.dir_name0.value);
...
<p><input type="button" name="b1" value="Check Directory Name" onclick="checkDirName()" >
&nbsp;&nbsp;&nbsp;<input type="button" name="b1" value="Go To OCR Page 2" onclick="loadDirName()" >
