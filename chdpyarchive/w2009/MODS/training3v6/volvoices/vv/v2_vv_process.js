...
parent.U.document.UF.XMLPATH.value = aSelectXMLPATH_index2a[ii].tran;
parent.U.document.UF.XMLPATHFULL.value = aSelectXMLPATH_index2a[ii].tran;
...
if (b6.length>0) {
     var db_01 = new Array; 
     db_01 = b6.split(";");
     if (db_01[0] != "undefined" ) { 
	var extent01 = new String(db_01[0]);
	    extent01 = extent01.replace(' digital images','');
	    parent.U.document.UF.extent_pages.value = extent01; 
	}
