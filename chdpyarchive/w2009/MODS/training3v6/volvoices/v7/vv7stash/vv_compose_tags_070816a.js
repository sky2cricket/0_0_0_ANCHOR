...
var numSB = new Number(parent.U.document.UF.numSubjectBlocks.value);

/*
var a = new String(""); //subject_OX
var b = new String(""); //subject_auth_0X
var c = new String(""); //subject_auth_close_0X
var str_a = new String(""); //subject_OX
var str_b = new String(""); //subject_auth_0X
var str_c = new String(""); //subject_auth_close_0X

alert ("parent.U.document.UF.subject_block_list.value="+
	parent.U.document.UF.subject_block_list.value);
*/

for (k=0;k<numSB;k++) {
/*
str_a="a=parent.D.document.DF.subject_0"+k+".value";
str_b="b=parent.D.document.DF.subject_0"+k+"_auth.value";
str_c="c=parent.D.document.DF.subject_0"+k+"_auth_close.value";
...
str = str.replace(/<\/mods:subject>/,"<br>&lt;\/mods:subject>");
str = str.replace(/<\/mods:cartographics>/,"<br>&lt;\/mods:cartographics>");
str = str.replace(/<\/mods:hierarchicalGeographic>/,"<br>&lt;\/mods:hierarchicalGeographic>"); 
str = str.replace(/<\/mods:name>/,"<br>&lt;\/mods:name>");
str = str.replace(/<\/mods:titleInfo>/,"<br>&lt;\/mods:titleInfo>");
