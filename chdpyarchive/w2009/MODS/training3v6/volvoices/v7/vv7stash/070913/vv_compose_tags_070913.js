...
}//end function page_04  with multiple subject blocks
...
if ( thisDocument.forms[0].physical_location_repository.value.length > 0 ) {
ps[ps.length]= new String(obrak+'mods:physicalLocation type="repository">'
        + bfont + replace_apos(thisDocument.forms[0].physical_location_repository.value) + efont
...
if ( thisDocument.forms[0].physical_location_city.value.length > 0 ) {
ps[ps.length]= new String(obrak+'mods:physicalLocation type="city">'
        + bfont + replace_apos(thisDocument.forms[0].physical_location_city.value) + efont
        + obrak+'/mods:physicalLocation>\r\n'
        );
}
...
if ( thisDocument.forms[0].physical_location_state.value.length > 0 ) {
ps[ps.length]= new String(obrak+'mods:physicalLocation type="state">'
        + bfont + replace_apos(thisDocument.forms[0].physical_location_state.value) + efont
        + obrak+'/mods:physicalLocation>\r\n'
        );
}
...
if ( thisDocument.forms[0].collection_id_name.value != "" ) {
//alert("thisDocument.forms[0].collection_id_name.value=\n"+thisDocument.forms[0].collection_id_name.value);
ps[ps.length]= new String(obrak+'mods:physicalLocation type="collection">'
        + bfont + replace_apos(thisDocument.forms[0].collection_id_name.value) +efont
        + obrak+'/mods:physicalLocation>\r\n'
        );
}
...
if ( thisDocument.forms[0].collection_id_number != "" ) {

	var colidn_type = new String("");

	for ( i=0; i<6; i++ ) {
        if (thisDocument.forms[0].collection_id_num_type[i].selected == true) {
                colidn_type = thisDocument.forms[0].collection_id_num_type.value;
                }
	}

	if (colidn_type != "none" ) {
		ps[ps.length]= new String(obrak+'mods:physicalLocation type="'+bfont+colidn_type+efont+'">'
        	+ bfont + replace_apos(thisDocument.forms[0].collection_id_number.value) +efont  ///function 06_dev
        	+ obrak+'/mods:physicalLocation>\r\n'
        	);
