...
xREADONLY name="name_type_'+sN+'"> name_type_'+sN+'  '
	+'</td> <td>&nbsp</td> </tr>'
...
xREADONLY name="name_authority_'+sN+'"> name_authority_'+sN+' '
...
size="1">&nbsp;'
	...
	+'<input type="text" name="namepart_family_'+sN+'" value=""
size="4">&nbsp;&nbsp;&nbsp;&nbsp;'
	+'<input type="text" name="creator_lastname_'+sN+'" value="Smith"
size="58" '
	...
	+' <tr class="bgstandard" ><td colspan="4"><font face="arial"
size="1">&nbsp;'
	+' <input type="text" name="namepart_given_'+sN+'" value=""
size="4">&nbsp;&nbsp;&nbsp;&nbsp; '
...
size="1"> &nbsp;'
	+' <input type="text" name="namepart_date_'+sN+'" value=""
size="4">&nbsp;&nbsp;&nbsp;&nbsp; '
	+' <input type="text" name = "creator_fulldatestr_'+sN+'" value=""
...
class="label13nou">'
	...
	+' <input type="text" name="creator_description_'+sN+'" value="" size="36"
...
description</font></td></tr>'
	+' <tr><td>' 
	+'<input type="text" name="creator_rolea_auth_'+sN+'" value="" size="7" >
&nbsp; </td><td>'
	+' <input type="text" name="creator_rolea_'+sN+'" value="" size="12"
xREADONLY class="required300w"> </td></tr>'
	+' <tr><td>'
	+' <input type="text" name="creator_roleb_auth_'+sN+'" value="" size="7" >
&nbsp; </td><td> '
	+' <input type="text" name="creator_roleb_'+sN+'" value="" size="12"
xREADONLY class="notrequired300w"> '
	+' </td></tr> <tr><td> '
	+' <input type="text" name="creator_rolec_auth_'+sN+'" value="" size="7" >
&nbsp; '
	+' </td><td>'
	+' <input type="text" name="creator_rolec_'+sN+'" value="" size="12"
xREADONLY class="notrequired300w"> '
	+'</td></tr> '
	+'</table>'
	+' </td> <td>&nbsp</td> </tr> '
