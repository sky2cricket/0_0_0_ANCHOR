...
<tr class="bgstandard" ><td colspan="3" xclass="label12u">

<?php

$greenrow='<tr class="greenrow"><td colspan="3" >&nbsp;</td></tr>';
...
copy($fullPathFileName,$fullPathTempName) or die("copy fail$greenrow$greenrow$greenrow"); #chmod 777 dp_ocr_temp.txt -- this copy statement worked

$file_reader = fopen($fullPathTempName,"rb") or die("Couldn't open file$greenrow$greenrow$greenrow");
