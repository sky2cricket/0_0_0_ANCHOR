...
if (mysql_num_rows($iresult))
 {
	...
	###BAD IDEA!!! $str_instfulladd  = "$str_instname $str_instadd $str_instcity $str_inststate $str_instzip";
...
###BAD IDEA! print "var adb_instfulladd = '$str_instfulladd';\n';
...
if ( parent.adb_username == "cricket" ) {
	alert("testw2009");
...
} else if (   parent.adb_username == "cricket" || parent.adb_username == "paulc" || parent.adb_username == "bdysonsm"  ) {
