...
commentFilename    = obrak+"!-- FILENAME: " +bfont+ parent.U.document.UF.VVcomment_01.value +efont+ " -->";
commentNumTiffs    = obrak+"!-- Number of Constituent Files: " +bfont+ parent.U.document.UF.VVcomment_02.value+efont+" -->";
commentBeginDate   = obrak+"!-- Record Creation Date: " +bfont+ parent.U.document.UF.VVcomment_03b.value+efont+ " -->";
commentRecentDate=obrak+"!-- Most Recent Record Creation Date: "+bfont+parent.U.document.UF.VVcomment_03d.value+efont+" -->";
commentReloadStatus= obrak+"!-- Reload Status: " +bfont+ parent.U.document.UF.VVcomment_03r.value+efont+ " -->";
commentContributor = obrak+"!-- Content Contributor: " +bfont+ parent.U.document.UF.VVcomment_03c.value+efont+ " -->";
commentInstitution = obrak+"!-- Institution: " +bfont+ parent.U.document.UF.VVcomment_03i.value+efont+ " -->";
commentProject     = obrak+"!-- Project: " +bfont+ parent.U.document.UF.VVcomment_03p.value+efont+ " -->";
commentValidate    = obrak+"!-- PAGE VALIDATION " +bfont+ parent.U.document.UF.VVcomment_04.value +efont+ " -->";
