...
#drush -v   --parent=chd2016:cdf  --namespace=cdf  --user=cdeane  --uri=http://localhost ibbp  --type=directory  --content-models=islandora:sp_videoCModel  --strict=0    --scan_target=/gwork/cdeane/CDF2016/cdf_test/0116_000050_000290/  ;

#ibbp no longer exist

#drush -v   --parent=chd2016:cdf  --namespace=cdf  --user=cdeane  --uri=http://localhost ibsp  --type=directory  --content-models=islandora:sp_videoCModel  --strict=0    --scan_target=/gwork/cdeane/CDF2016/cdf_test/0116_000050_000290/  ;
...
#python     /gwork/cdeane/000PY/exec_ingest_video_dlwork.py /gwork/cdeane/CDF2016/ingest_target
