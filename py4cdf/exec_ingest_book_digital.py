...
#drush -v   --parent=collections:cdf  --namespace=cdf  --user=cdeane  --uri=http://localhost ibbp  --type=directory  --content-models=islandora:bookCModel  --strict=0    --scan_target=/gwork/cdeane/CDF2016/cdf_test/0116_000050_000290/  ;

#ibbp no longer exist

#drush -v   --parent=collections:cdf  --namespace=cdf  --user=cdeane  --uri=http://localhost ibsp  --type=directory  --content-models=islandora:bookCModel  --strict=0    --scan_target=/gwork/cdeane/CDF2016/cdf_test/0116_000050_000290/  ;
...
# python    t0.py     /gwork/cdeane/CDF2016/ingest_target/    LIVE

#python     /gwork/cdeane/000PY/exec_ingest_book_digital.py /gwork/cdeane/CDF2016/ingest_target/
...
Target         = " --scan_target=/gwork/cdeane/CDF2016/ngest_target/ "  
