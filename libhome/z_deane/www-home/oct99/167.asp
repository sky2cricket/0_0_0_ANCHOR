...
Sub Button05c_OnClick '''integer 4digit year  
        ...
        Set objSelHUN = ThisForm.selHUN   
        Set objSelTEN = ThisForm.selTEN   
        Set objSelONE = ThisForm.selONE   

        strResult = "Four Digit Year:    "
        strResult = strResult & YEAR_HUN(objSelHUN.Options.SelectedIndex)
        strResult = strResult & YEAR_DIGITS(objSelTEN.Options.SelectedIndex)
        strResult = strResult & YEAR_DIGITS(objSelONE.Options.SelectedIndex)
        MsgBox strResult
End Sub
