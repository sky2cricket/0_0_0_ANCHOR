...
[01234567689abcdefABCDEF]  

<form NAME="FORM1" METHOD=POST ACTION="colorbox.cgi">
<table border=0 cellspacing=0>
<tr>
<td bgcolor="ffffff"> <font color="000000"> Current Background color:  $BGcolor </td>
<td bgcolor="ffffff"> <font color="000000"> Current Text color: $TXcolor </td>
</tr> <tr>
<td bgcolor="ffffff"> <font color="000000"> New Background color:
<Input Type=TEXT NAME="hBGcolor" VALUE="$BGcolor" size=6 maxlength=6></td>
<td bgcolor="ffffff"> <font color="000000"> New Text color:
...
<INPUT TYPE=SUBMIT VALUE="ENTER NEW COLORS"> </form> 
