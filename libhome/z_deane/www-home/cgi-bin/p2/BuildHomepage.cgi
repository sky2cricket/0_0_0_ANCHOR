...
#This program needs a "temp" directory 
#to hold the file BHinfoFile.
#Both the file and the directory have permissions 706,
#to allow world writing to the file.
...
$TITLEA = "BuildHomepage.cgi";
$TITLEB = "Build your first homepage, NOW!";
#orig: $FILENAME = "../../temp/BHInfoFile";
$FILENAME = "publicTemp/BHInfoFile";
$AUTOHTML = "../p2/auto.html";
$MAXSAVE = 1;
...
print (OUT "<html>","\n");
print (OUT "<head>","\n");
print (OUT "<title>auto.html</title>","\n");
print (OUT "</head>","\n");
print (OUT "<body bgcolor=$arrayBCV[1] text=$arrayTCV[1]",
  " link=$arrayLCV[1] >","\n");
print (OUT "<center>","\n");
printf(OUT "<h1>Welcome to the homepage for %s! </h1>",
  $cur->param("autoname"));
print (OUT "\n","</center>","\n");
print (OUT "<hr>","\n");
printf(OUT "<h3> My major area of study is %s.", 
  $cur->param("automajor"));
print (OUT "\n");
printf(OUT "<br> I am also interested in %s. ", 
  $cur->param("automajor2"));
print (OUT "\n");
printf(OUT "<br> I am planning to graduate in %s. ", 
  $cur->param("autograd"));
print (OUT "\n");
printf(OUT "<br> After college I would like %s. ", 
...
print (OUT "\n");
printf(OUT "<br> My email address is:  %s ", 
  $cur->param("autoemail"));
print (OUT "\n");
printf(OUT "<hr>");
print (OUT "\n");
printf(OUT "This page last updated: &nbsp;&nbsp;&nbsp; %s", 
  $cur->param("date")); 
print (OUT "\n");
printf(OUT "<hr>");
print (OUT "\n");
...
print p h4("An incorrect internet address will be a dead link on your page!"); 
...
print end_form;
print hr;
print h2("<a href=\"http://www.cs.utk.edu/~deane/cgi-bin/p2/auto.html\">",
         "Look at your page.</a> Remember to RELOAD your page!");

print h2(" HTML CODE FOR YOUR HOMEPAGE APPEARS BELOW");
print hr;
print ("< h t m l ><br>< h e a d ><br>");
print ("< t i t l e >auto.html< /t i t l e >");
print ("<br>< /h e a d > <br>");
printf("< b o d y &nbsp;&nbsp;&nbsp;  b g c o l o r = \"%s\" ",
  $arrayBCV[1]);
printf("&nbsp;&nbsp;&nbsp;  t e x t = \"%s\" ",
  $arrayTCV[1]);
printf("&nbsp;&nbsp;&nbsp;  l i n k = \"%s\" >",
