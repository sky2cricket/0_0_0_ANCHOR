...
//vv2_compose_w2009.js from vv_compose_tags.js    Dec 16 2009
...
return;
/*
var name_type_01_display = new String(document.DF.name_type_01.value);
var name_authority_01_display = new String(document.DF.name_authority_01.value);


//start mods:name 1
if (!name_type_01_display && !name_authority_01_display ){
ps[ps.length]=new String(obrak+'mods:name>\r\n');
}else if (!name_authority_01_display){
ps[ps.length]=new String(obrak+'mods:name type="'+name_type_01_display+'">\r\n');
}else{
ps[ps.length]=new String(obrak+'mods:name type="'+name_type_01_display+" authority="'+ name_authority_01_display+'">\r\n');
}
*/
...
//if (name_type_01_display=="personal"){
