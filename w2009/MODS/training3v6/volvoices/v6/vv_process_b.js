//vv_process_b.js
//same as vv_process.js 
//but all functions have _b appended to function name
...
function xxxxx_getFilenameDirectoryIndex_b ( aTupleArray, str ){
...
///========================================================================
///just to make parsing easier
function getDateQualifier_b(str) {
...
//=================================================================
function process_header_b(str,strConstituents) {
var s = new String(str);
...
function generate_file_list_tiff_reload_b() {
var str = new String();
...
str = str.substring(1);
return str;
}//end function generate_file_list_tiff_reload_b() 
...
return;
}// function process_name_b(N)

///========================================================================
function process_originInfo_b(str) {
...
}//end function process_originInfo_b


///========================================================================
function process_language_b(str) {
...
}//end function process_language_b

///========================================================================

function process_typeOfResource_b(str){
...
}//end function process_typeOfResource_b


///========================================================================
function process_genre_b(str) {
...
return;
}//end function process_genre_b


///========================================================================
function process_physicalDescription_b(str) {
...
return;
}//end function process_physicalDescription_b

///========================================================================
function process_abstract_b(str) {
...
}//end function process_abstract_b


///========================================================================
function process_subject_lcsh_b(str) {
...
return;
}//end function process_subject_lcsh_b(str) 


///========================================================================
function process_subject_tgm_b(str) {
...
}//end function process_subject_tgm_b(str) 

///========================================================================
function process_subject_vv_b(str) {
...
}//end function process_subject_vv_b(str) 

///========================================================================
function process_subject_spc_b(str) {
...
return;
}//end function process_subject_spc_b(str) 


///========================================================================
function process_subject_none_b(str) {
...
}//end function process_subject_none_b(str) 


///========================================================================
function process_location_b(str) {
...
return;
}//end function process_location_b(str)


///========================================================================
function process_note_b(str) {
...
}//end function process_note_b


///========================================================================
function process_recordInfo_b(str) {
...
return;
}///end function process_recordInfo_b(str)
