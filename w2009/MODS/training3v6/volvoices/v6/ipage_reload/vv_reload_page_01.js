...
function x_extract_tag_data(str,str1,str2){
...
var name_button_id = new String("parent.U.document.UF.name_button_id_");
if (str.indexOf("type=\"personal\"")>-1){
	name_type_attr=name_type_attr+strnum+".value=\"personal\";";
	//cannot do name_button_id = 1 or 2 here, must do on parse of "<mods:namePart" below	
}else if (str.indexOf("type=\"corporate\"")>-1){
	name_type_attr=name_type_attr+strnum+".value=\"corporate\";";
	name_button_id=name_button_id+strnum+".value=\"3\";";//corporate name
}else {
...
if (str.indexOf("<mods:namePart>")>-1) {
	name_button_id=name_button_id+strnum+".value=\"2\";";//complex personal name
	...
	name_button_id=name_button_id+strnum+".value=\"1\";";//simple personal name
