...
function deprecated_date_created_radio_pop(sbox) {
...
//function deprecated, but leave as example of how to do radio buttons
//original form vars from page 6.  These were taken off because they are custom code.
//<input type="radio" name="record_content_source_radio" onclick="parent.L.record_content_source_radio_pop(this)" value="EAST" >EAST
//<input type="radio" name="record_content_source_radio" onclick="parent.L.record_content_source_radio_pop(this)" value="MIDDLE">MIDDLE
//<input type="radio" name="record_content_source_radio" onclick="parent.L.record_content_source_radio_pop(this)" value="WEST">WEST
//<input type="radio" name="record_content_source_radio" onclick="parent.L.record_content_source_radio_pop(this)" value="OTHER">OTHER 
...
if ( sbox.value=='EAST' ) {
        ...
        parent.U.document.UF.record_content_source.value = dig_ctr_addr[0];
}else if ( sbox.value=='MIDDLE' ) {
        parent.D.document.forms[0].record_content_source.value = dig_ctr_addr[1];
        parent.U.document.UF.record_content_source.value = dig_ctr_addr[1];
}else if ( sbox.value=='WEST' ) {
        parent.D.document.forms[0].record_content_source.value = dig_ctr_addr[2];
        parent.U.document.UF.record_content_source.value = dig_ctr_addr[2];
}else if ( sbox.value=='OTHER' ) {
        parent.D.document.forms[0].record_content_source.value = dig_ctr_addr[3];
        parent.U.document.UF.record_content_source.value = dig_ctr_addr[3];
}

parent.U.document.UF.record_content_source_radio[0].checked = parent.D.document.DF.record_content_source_radio[0].checked;
parent.U.document.UF.record_content_source_radio[1].checked = parent.D.document.DF.record_content_source_radio[1].checked;
parent.U.document.UF.record_content_source_radio[2].checked = parent.D.document.DF.record_content_source_radio[2].checked;
parent.U.document.UF.record_content_source_radio[3].checked = parent.D.document.DF.record_content_source_radio[3].checked;
