...
///page_01/////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////
parent.U.document.UF.title.value=getEntityData("<mods:title>", mods_titleInfo);


parent.U.document.UF.name_authority_01.value = get_MODS_attribute(mods_name_01,"authority");
alert("got to here 0");
var iii = parent.L.getRadioIndex(mods_name_01,1);
alert("iii="+iii+"\nmods_name_01=\n"+mods_name_01);
parent.U.document.UF.name_authority_01_radio[iii].checked = true;
var name_type_01 = get_MODS_attribute(mods_name_01,"type");
alert('attribute: name_type_01='+name_type_01 );


alert('got to here 3');
var jjj = parent.L.getRadioIndex(name_type_01,2);
if ( jjj == 2) {
	parent.U.document.UF.creator_lastname_01.value="unknown";
}else if ( jjj == 3 ) {
	parent.U.document.UF.creator_lastname_01.value="anonymous";
}else if ( jjj == 1 ) {
	parent.U.document.UF.creator_lastname_01.value=getEntityData2('<mods:namePart>',mods_name_01);//corporate
}else if ( jjj == 0 ) {
	parent.U.document.UF.creator_lastname_01.value=getEntityData2('<mods:namePart type="family">',mods_name_01);
}



parent.U.document.UF.creator_radio_01[jjj].checked = true;

var name_given_01 = new String(getEntityData2('<mods:namePart type="given">',mods_name_01));
if (name_given_01.length>0 ){
	var ng_01 = new Array(); ng_01 = name_given_01.split(" ");
	if (ng_01[0] != "undefined" ) { parent.U.document.UF.creator_firstname_01.value  = ng_01[0]; }
	if (ng_01[1] != "undefined" ) { parent.U.document.UF.creator_middlename_01.value = ng_01[1]; }
	}

var dob_01 = new String(getEntityData2('<mods:namePart type="date">',mods_name_01));
if (dob_01.length>0) {
	var db_01 = new Array; db_01 = dob_01.split("-");
	if (db_01[0] != "undefined" ) { parent.U.document.UF.creator_dob_01.value = db_01[0]; }
	if (db_01[1] != "undefined" ) { parent.U.document.UF.creator_dod_01.value = db_01[1]; }
	}

parent.U.document.UF.creator_description_01.value = getEntityData2('<mods:description>',mods_name_01);
parent.U.document.UF.creator_role_01.value        = getEntityData2('<mods:roleTerm authority="marcrelator">',mods_name_01);


/*
if ( mods_name_02.length == 0 ) {
	parent.U.document.UF.creator_radio_02[0].checked = true;
}else{	
	///process mods_name_02
parent.U.document.UF.name_authority_02.value = get_MODS_attribute(mods_name_02,"authority");
var ii2 = parent.L.getIndexOfRadioButtonChecked(parent.L.aNameAuthority,parent.U.document.UF.name_authority_02.value);
parent.U.document.UF.name_authority_02_radio[ii2].checked = true;
var name_type_02 = get_MODS_attribute(mods_name_02,"type");

parent.U.document.UF.creator_lastname_02.value=getEntityData2('<mods:namePart type=',mods_name_02);
var jj2 = parent.L.getIndexOfRadioButtonChecked(parent.L.aCreatorRadio,mods_name_02);
parent.U.document.UF.creator_radio_01[jj2].checked = true;

}//end else 
*/


if ( mods_name_03.length == 0 ) {
	parent.U.document.UF.creator_radio_03[0].checked = true;
}else{	
	///process mods_name_03
...
//get mods subelement from mods top level element 
...
var startTag = new String("<"+elementName);
	if ( attribute != "x" && fromString.indexOf(attribute)> -1  ) { startTag = startTag+" "+attribute; }
...
function getEntityData2 ( strTagDelim, strBlock ) {

var sHead = new String("getEntityData2("+strTagDelim+","+strBlock+")\n\n");

var B = new String(strBlock);
    //B = B.substring(localCursor);
    B = B.substring(B.indexOf(strTagDelim));
...
}//end function getEntityData2( strTagDelim, strBlock ) 
