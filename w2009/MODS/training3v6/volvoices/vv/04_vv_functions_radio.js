...
function creator_radio_01_pop(sbox) {//called by creator_radio_01
	...
	document.forms[0].creator_dob_01.value = "";
	document.forms[0].creator_dod_01.value = "";
	}
	...
	document.forms[0].creator_firstname_01.value = "";
	document.forms[0].creator_middlename_01.value = "";
	if (document.forms[0].name_authority_01_radio[2].checked ) {//corp allowed LCNAF
		alert("You may not specify NameAuthority=ULAN if the creator is corporate.");
		document.forms[0].name_authority_01_radio[0].checked = true;//can be specific to _01 here
		document.forms[0].name_authority_01.value = "NONE"; //because the primary name type selection only for _01
	}
	document.forms[0].creator_dob_01.value = "";
	document.forms[0].creator_dod_01.value = "";
	}
...
if ( document.forms[0].creator_radio_02[2].checked ) {//second name not a person
	...
	if (document.forms[0].name_authority_02_radio[2].checked ) {
...
if ( document.forms[0].creator_radio_03[2].checked ) {//third name not a person
	...
	document.forms[0].creator_dob_03.value = "";
	document.forms[0].creator_dod_03.value = "";
	if (document.forms[0].name_authority_03_radio[2].checked ) {//corp not allow ULAN
...
if ( document.forms[0].name_authority_01_radio[1].checked ) { //LCNAF
	if (    document.forms[0].creator_radio_01[2].checked //unknown
	    ||  document.forms[0].creator_radio_01[3].checked //anonymous 
	){
...
if ( document.forms[0].name_authority_01_radio[2].checked ) { //ULAN
	if (    document.forms[0].creator_radio_01[1].checked //corporate
	    ||  document.forms[0].creator_radio_01[2].checked //unknown
	    ||  document.forms[0].creator_radio_01[3].checked //anonymous 
	){
...
if ( document.forms[0].name_authority_02_radio[2].checked ) { //ULAN
	if (    document.forms[0].creator_radio_02[2].checked //corporate
	){
...
if ( document.forms[0].name_authority_03_radio[2].checked ) { //ULAN
	if (    document.forms[0].creator_radio_03[2].checked //corporate
	){
		alert("You may not specify NameAuthority=ULAN for corporate.");
		document.forms[0].name_authority_03_radio[0].checked = true;
		document.forms[0].name_authority_03_radio[1].checked = false;
