...
#command line:
#python makeRisPpi.py source_dir  target_dir >> redirectText
#python makeRisPpi.py ppiIN       ppiOUT     >> optionalLog.txt

#use a log file instead of print to screen.

#commonalities for ppi files
...
testTitlePost = "" ###" - 130806 docBlock6 PPI "
